Invoke-Expression $env:Qt5_Dir\5.14.0\mingw73_64\bin\qtenv2.bat
cd $env:GITHUB_WORKSPACE
Invoke-Expression $env:Qt5_Dir\5.14.0\mingw73_64\bin\qmake
Invoke-Expression $env:Qt5_Dir\Tools\mingw730_64\bin\mingw32-make.exe
cd Main\release
mkdir Anthem
Copy-Item Main.exe -Destination Anthem
cd Anthem
Invoke-Expression $env:Qt5_Dir\5.14.0\mingw73_64\bin\windeployqt.exe Main.exe --qmldir $env:GITHUB_WORKSPACE\Main
