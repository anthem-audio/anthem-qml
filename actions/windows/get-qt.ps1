...
$app = Get-WmiObject -Class Win32_Product -Filter "Name LIKE 'Microsoft Visual C++*'" | Write-output $app | $app
$app = Get-WmiObject -Class Win32_Product -Filter "Name LIKE 'Microsoft Visual C++*'" | foreach-object -process {$app.Uninstall()}
