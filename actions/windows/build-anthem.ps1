...
Copy-Item "D:\Qt\5.13.1\mingw73_64\bin\libgcc_s_seh-1.dll" -Destination "libgcc_s_seh-1.dll"
Copy-Item "D:\Qt\5.13.1\mingw73_64\bin\libwinpthread-1.dll" -Destination "libwinpthread-1.dll"
Copy-Item "D:\Qt\5.13.1\mingw73_64\bin\libstdc++-6.dll" -Destination "libstdc++-6.dll"
cd ..
